...
int main() {
    ...
    while (std::cin >> command) {
        if (command == "create") {
            ...
            if (compare == '<') {
                std::cout << std::boolalpha << Addresses[lhs].Less(Addresses[rhs]) << "\n";
            } else if (compare == '=') {
                std::cout << std::boolalpha << Addresses[lhs].Equal(Addresses[rhs]) << "\n";
            } else if (compare == '>') {
                std::cout << std::boolalpha << Addresses[lhs].More(Addresses[rhs]) << "\n";
            }
